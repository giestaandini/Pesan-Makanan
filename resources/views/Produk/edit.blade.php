...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="card mt-3">
        ...
        @endif
        <div class="card-body">
            <form method="post" action="{{ url('admin/menu/'.$data->name ) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                  <label>ID kategori</label>
                  <input type="numeric" class="form-control" name="category_id" value="{{ $data->category_id }}" required>
              </div>
              <br>
              <div class="mb-3">
                <label for="image">Gambar</label>
                <input type="file" accept="image/*" name="picture" id="image" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="mb-3">
                  <label>Harga</label>
                  <input type="text" class="form-control" name="price" value="{{ $data->price }}" placeholder="Rp" required>
                </div>
                <div class="form-group">
                  <label>Status</label>
                ...
                <a class="btn btn-primary" href="/admin/menu" role="button"><span data-feather="log-out"></span> Keluar</a>
            </form>
        </div>
    </div>
    <!-- akhir card form -->
