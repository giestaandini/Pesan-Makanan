...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="pb-3">
        <form class="d-flex" action="{{ url('admin/menu')}}" method="GET">
      ...
      <a href="/admin/menu/create" class="btn btn-primary"><span data-feather="plus"></span>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td>
            <img src="{{ url('storage/promo/'.$product->picture)}}" width="100px" >
          </td>
          <td>{{ $product->name }}</td>
          <td>{{ $product->price }}</td>
          ...
          <td>
            <a href="{{ url('admin/menu/'.$product->name.'/edit') }}" class="btn btn-warning"><span data-feather="edit"></span></a>
            <form onsubmit="return confirm('Yakin Anda Ingin Menghapus Produk Ini?')" class='d-inline' action="{{ url('admin/menu/'.$product->name) }}"
              method="POST">
              @csrf
              @method('DELETE')
