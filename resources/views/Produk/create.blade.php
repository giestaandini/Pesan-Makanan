        ...
        <div class="card-body">
            <form method="post" action="{{ url('admin/menu') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="numeric" class="form-control" name="category_id" value="{{ Session::get('category_id') }}" required>
              </div>
              <br>
                <div class="form-group">
                ...
                <div class="mb-3">
                  <label>Harga</label>
                  <input type="text" class="form-control" name="price" value="{{ Session::get('price') }}" placeholder="Rp" required>
                </div>
                {{-- <div class="form-group">
                ...
                <input type="file" class="form-control" name="picture" value="{{ Session::get('picture') }}" required>
                <div>
